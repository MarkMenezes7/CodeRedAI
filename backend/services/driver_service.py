...
_OFFER_TTL_SECONDS = 30         # configurable offer timeout
...
def find_nearest_drivers(
    ...
    for doc in docs:
        ...
        drivers.append({
            "driver_id": doc.get("email", str(doc["_id"])),
            ...
            "distance_m": None,  # MongoDB $near doesn't return distance directly with find()
        })
